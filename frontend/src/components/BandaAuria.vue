...
export default {
    ...
    computed: {
        momentsFiltrats() {
            if (this.edat === null || this.edat === undefined) return this.totsElsMoments;

            return this.totsElsMoments.filter(moment => {
                if (moment.tipus === 'banda' && this.edat < 15) return false;
                if (moment.tipus === 'contrabanda' && this.edat >= 15) return false;
                return true;
            });
        }
    },
...
<template>
    <div class="banda-wrapper">
        ...
        <div class="form-section">
            ...
            <select v-model="instrument" class="custom-select">
        ...
        <div class="form-section">
            ...
            <div class="moments-grid">
                <div v-for="moment in momentsFiltrats" :key="moment.id" class="moment-card"
                    :class="{ 'moment-selected': moments.includes(moment.text) }">
                    <label class="moment-label">
                        <input type="checkbox" :value="moment.text" v-model="moments">
        ...
        <div class="form-section">
            ...
            <textarea v-model="observacions" placeholder="Altres comentaris, preferències o detalls rellevants..."
