...
<template>
  <div class="banda-wrapper">
    ...
    <div class="info-box">
      <p>🎷Tria el teu instrument, els actes i les cercaviles on vols participar i ens encarregarem de fer-te arribar i
        gestionar el que faci falta. (No busquis les gralles que no són benvingudes😝)</p>
    </div>
    ...
    <div class="form-section">
      ...
      <textarea v-model="detallsBanda.observacions"
        placeholder="Altres comentaris, preferències o detalls rellevants..." rows="4"
